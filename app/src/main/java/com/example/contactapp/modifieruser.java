...
public class modifieruser extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modifieruser);
...
//        password.setText(user.getPassword());
    ...
    void insertNewContact(String date ,String nomContact, String prenomContact, String Pass, String telContact){
        ...
        docRef.document(user.getEmail()).set(contactAttributs);
    }
